...
public class ByteBlobTest extends TestCase {
	...
	static public void test() {
		...
		// getBits
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 0)
			== 0);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 1)
			== 1);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 2)
			== 3);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 3)
			== 7);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 4)
			== 15);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 5)
			== 31);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 6)
			== 63);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 7)
			== 127);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 8)
			== 255);
		assertTrue(new ByteBlob(new byte[]{(byte)0xff}).getBits(0, 9)
			== 255);
		...
		// crc16
		assertTrue(new ByteBlob().crc16() == 0xffff);
		assertTrue(new ByteBlob(five).crc16() == 47914);
		assertTrue(new ByteBlob(
			new byte[] {1, 2, 3, 4, 5, 6}).crc16(0, 5) == 47914);
		assertTrue(new ByteBlob(five).crc16(0, 5) == 47914);
		assertTrue(new ByteBlob(five).crc16(-5, 20) == 47914);
