...
public enum SystemAttrEnum {
	...
	CAMERA_COHU_CONN_MODE(0, 0, 1, Change.RESTART_SERVER),
	CAMERA_COHU_MAX_IDLE(30, 0, 86400, Change.RESTART_SERVER),
	...
	CAMERA_PELCOD_CONN_MODE(0, 0, 1, Change.RESTART_SERVER),
	CAMERA_PELCOD_MAX_IDLE(30, 0, 86400, Change.RESTART_SERVER),
	...
	CAMERA_PTZ_FIXED_SPEED(false, Change.RESTART_SERVER),
	CAMERA_PTZ_FORCE_FULL(false, Change.RESTART_SERVER),
