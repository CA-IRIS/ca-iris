...
public enum SystemAttrEnum {
	...
	CAMERA_SHIFT_CONCUR_MOVE(1, 1, 100, Change.RESTART_SERVER),
	CAMERA_SHIFT_MOVE_PAUSE(1, 0, 120, Change.RESTART_SERVER),
	CAMERA_SHIFT_SUNRISE_OFFSET(0, -60, 60, Change.RESTART_SERVER),
	CAMERA_SHIFT_SUNSET_OFFSET(0, -60, 60, Change.RESTART_SERVER),
