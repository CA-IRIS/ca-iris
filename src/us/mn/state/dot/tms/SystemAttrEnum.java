...
public enum SystemAttrEnum {
	...
	CAMERA_DIRECTION_OVERRIDE("", Change.RESTART_CLIENT),
	CAMERA_ID_BLANK(""),
	...
	CAMERA_SHIFT_CONCUR_MOVE(0, 0, Change.RESTART_SERVER),
	CAMERA_SHIFT_MOVE_PAUSE(5, 0, Change.RESTART_SERVER),
	CAMERA_SHIFT_REINIT(false, Change.RESTART_SERVER),
	CAMERA_SHIFT_SUNRISE_OFFSET(-30, -120, 120, Change.RESTART_SERVER),
	CAMERA_SHIFT_SUNSET_OFFSET(-30, -120, 120, Change.RESTART_SERVER),
	CAMERA_SORT(0, 0, 2, Change.RESTART_CLIENT),
	CAMERA_STREAM_CONTROLS_ENABLE(false, Change.RESTART_CLIENT),
	CAMERA_STREAM_DURATION_SECS(0, 0, Change.RESTART_CLIENT),
	...
	DETECTOR_REDUCE_MALF_LOGGING(false, Change.RESTART_SERVER),
	...
	DMS_ACTION_DURATION_MINUTES(0, 0, 600),
	...
	ROUTE_MAX_LINK_MILES(0.6F, 0.6F, 100.0F, Change.RESTART_SERVER),
	...
	SYSTEM_MIN_PASSWORD_LENGTH(8, 0, 20),
