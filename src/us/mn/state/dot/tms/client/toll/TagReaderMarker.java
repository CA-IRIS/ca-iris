 ...
 * @author Douglas Lau
 */
public class TagReaderMarker extends Marker {
	...
	public TagReaderMarker() {
		...
		lineTo(0, fscale(37));
		lineTo(fscale(37), 0);
		append(makeArc(37, 0, 180), true);
		closePath();
		append(makeArc(52, -210, -120), false);
		append(makeArc(66, 35, 110), true);
		closePath();
		append(makeArc(80, -218, -104), false);
		append(makeArc(94, 40, 100), true);
		closePath();
		append(makeArc(108, -222, -96), false);
		append(makeArc(122, 43, 94), true);
		closePath();
	}
}
