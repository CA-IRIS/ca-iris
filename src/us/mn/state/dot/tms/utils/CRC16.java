...
public class CRC16 implements Checksum {
	...
	/** Polynomial table */
	private static final int[] poly_table = {
	...
	/** Update the current checksum with the specified byte. */
	public void update(int b) {
		final int idx = (crc_sum ^ (b & 0xff)) & 0xff;
		final int y = poly_table[idx];
		crc_sum = (crc_sum >> 8) ^ y;
	}
