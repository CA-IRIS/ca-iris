...
public class SCsv {
	...
	/**
	 * Get time field as epoch value.
	 * @param fs Array of fields
	 * @param i Index into fs containing time field
	 *          (format "MM/dd/yyyy HH:mm:ss")
	 * @return Epoch value, or -1 on error.
	 */
	 ...
	 * @return The date as an epoch value, or -1 on error.
	 */
