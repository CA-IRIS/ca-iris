...
public interface DisplayPort {
    ...
    @RequestWrapper(localName = "GetServiceCapabilities", targetNamespace = "http://www.onvif.org/ver10/display/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.display.wsdl.GetServiceCapabilities")
    @ResponseWrapper(localName = "GetServiceCapabilitiesResponse", targetNamespace = "http://www.onvif.org/ver10/display/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.display.wsdl.GetServiceCapabilitiesResponse")
    @WebResult(name = "Capabilities", targetNamespace = "http://www.onvif.org/ver10/display/wsdl")
    us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.display.wsdl.Capabilities getServiceCapabilities();
    ...
    GetPaneConfigurationResponse getPaneConfiguration(
    ...
    GetPaneConfigurationsResponse getPaneConfigurations(
    ...
    DeletePaneConfigurationResponse deletePaneConfiguration(
    ...
    CreatePaneConfigurationResponse createPaneConfiguration(
    ...
    SetPaneConfigurationsResponse setPaneConfigurations(
    ...
    SetPaneConfigurationResponse setPaneConfiguration(
    ...
    GetDisplayOptionsResponse getDisplayOptions(
