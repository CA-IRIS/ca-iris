 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AccessPoint" type="{http://www.onvif.org/ver10/accesscontrol/wsdl}AccessPoint" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetAccessPointsResponse")
public class GetAccessPointsResponse {

    @XmlElement(name = "AccessPoint")
    protected List<AccessPoint> accessPoint;
    ...
    public List<AccessPoint> getAccessPoint() {
        if (accessPoint == null) {
            accessPoint = new ArrayList<AccessPoint>();
        }
