 ...
 *         &lt;element name="AccessProfileToken" type="{http://www.onvif.org/ver10/pacs}ReferenceToken" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "DeleteCredentialAccessProfiles")
public class DeleteCredentialAccessProfiles {
    ...
    protected List<String> accessProfileToken;
     ...
     * This is why there is not a <CODE>set</CODE> method for the accessProfileToken property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAccessProfileToken().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getAccessProfileToken() {
        if (accessProfileToken == null) {
            accessProfileToken = new ArrayList<String>();
        }
        return this.accessProfileToken;
    }
