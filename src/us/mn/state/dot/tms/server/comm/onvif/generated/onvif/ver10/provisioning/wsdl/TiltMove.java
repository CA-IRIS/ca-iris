 ...
 *         &lt;element name="Direction" type="{http://www.onvif.org/ver10/provisioning/wsdl}TiltDirection"/&gt;
...
@XmlRootElement(name = "TiltMove")
public class TiltMove {

    @XmlElement(name = "VideoSource", required = true)
    protected String videoSource;
    @XmlElement(name = "Direction", required = true)
    @XmlSchemaType(name = "string")
    protected TiltDirection direction;
     ...
     *     
     */
    public void setDirection(TiltDirection value) {
