 ...
 *         &lt;element name="SecurityLevel" type="{http://www.onvif.org/ver10/authenticationbehavior/wsdl}SecurityLevel" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetSecurityLevelListResponse")
public class GetSecurityLevelListResponse {

    @XmlElement(name = "NextStartReference")
    protected String nextStartReference;
    @XmlElement(name = "SecurityLevel")
    protected List<SecurityLevel> securityLevel;
     ...
     * This is why there is not a <CODE>set</CODE> method for the securityLevel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSecurityLevel().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<SecurityLevel> getSecurityLevel() {
        if (securityLevel == null) {
            securityLevel = new ArrayList<SecurityLevel>();
        }
