 ...
 *         &lt;element name="Direction" type="{http://www.onvif.org/ver10/provisioning/wsdl}ZoomDirection"/&gt;
...
@XmlRootElement(name = "ZoomMove")
public class ZoomMove {

    @XmlElement(name = "VideoSource", required = true)
    protected String videoSource;
    @XmlElement(name = "Direction", required = true)
    @XmlSchemaType(name = "string")
    protected ZoomDirection direction;
     ...
     *     
     */
    public void setDirection(ZoomDirection value) {
