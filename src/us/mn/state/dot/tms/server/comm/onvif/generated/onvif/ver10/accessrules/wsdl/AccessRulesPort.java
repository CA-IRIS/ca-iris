...
public interface AccessRulesPort {
    ...
    @RequestWrapper(localName = "ModifyAccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.ModifyAccessProfile")
    @ResponseWrapper(localName = "ModifyAccessProfileResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.ModifyAccessProfileResponse")
    void modifyAccessProfile(
    ...
    @RequestWrapper(localName = "GetAccessProfiles", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfiles")
    @ResponseWrapper(localName = "GetAccessProfilesResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfilesResponse")
    @WebResult(name = "AccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
    java.util.List<AccessProfile> getAccessProfiles(
    ...
    @RequestWrapper(localName = "GetAccessProfileInfo", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfileInfo")
    @ResponseWrapper(localName = "GetAccessProfileInfoResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfileInfoResponse")
    @WebResult(name = "AccessProfileInfo", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
    java.util.List<us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.AccessProfileInfo> getAccessProfileInfo(
            @WebParam(name = "Token", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
                    java.util.List<String> token
    );
    ...
    @RequestWrapper(localName = "GetServiceCapabilities", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetServiceCapabilities")
    @ResponseWrapper(localName = "GetServiceCapabilitiesResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetServiceCapabilitiesResponse")
    @WebResult(name = "Capabilities", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
    us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.ServiceCapabilities getServiceCapabilities();
    ...
    @RequestWrapper(localName = "GetAccessProfileList", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfileList")
    @ResponseWrapper(localName = "GetAccessProfileListResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfileListResponse")
    void getAccessProfileList(
    ...
    @RequestWrapper(localName = "DeleteAccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.DeleteAccessProfile")
    @ResponseWrapper(localName = "DeleteAccessProfileResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.DeleteAccessProfileResponse")
    ...
    @RequestWrapper(localName = "CreateAccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.CreateAccessProfile")
    @ResponseWrapper(localName = "CreateAccessProfileResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.CreateAccessProfileResponse")
    @WebResult(name = "Token", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
    String createAccessProfile(
            @WebParam(name = "AccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
                    AccessProfile accessProfile
    );
     ...
     * 			
     */
    @WebMethod(operationName = "SetAccessProfile", action = "http://www.onvif.org/ver10/accessrules/wsdl/SetAccessProfile")
    @RequestWrapper(localName = "SetAccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.SetAccessProfile")
    @ResponseWrapper(localName = "SetAccessProfileResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.SetAccessProfileResponse")
    ...
    @RequestWrapper(localName = "GetAccessProfileInfoList", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfileInfoList")
    @ResponseWrapper(localName = "GetAccessProfileInfoListResponse", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.GetAccessProfileInfoListResponse")
    void getAccessProfileInfoList(
            @WebParam(name = "Limit", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
                    Integer limit,
            @WebParam(name = "StartReference", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
                    String startReference,
            ...
            @WebParam(mode = WebParam.Mode.OUT, name = "AccessProfileInfo", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
                    javax.xml.ws.Holder<java.util.List<us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.accessrules.wsdl.AccessProfileInfo>> accessProfileInfo
    );
}
