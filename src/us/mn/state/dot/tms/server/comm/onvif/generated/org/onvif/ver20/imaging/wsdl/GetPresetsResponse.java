 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Preset" type="{http://www.onvif.org/ver20/imaging/wsdl}ImagingPreset" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetPresetsResponse {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2018-08-07T08:47:22-05:00", comments = "JAXB RI v2.2.11")
    protected List<ImagingPreset> preset;
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2018-08-07T08:47:22-05:00", comments = "JAXB RI v2.2.11")
    public List<ImagingPreset> getPreset() {
        if (preset == null) {
            preset = new ArrayList<ImagingPreset>();
        }
        return this.preset;
    }
