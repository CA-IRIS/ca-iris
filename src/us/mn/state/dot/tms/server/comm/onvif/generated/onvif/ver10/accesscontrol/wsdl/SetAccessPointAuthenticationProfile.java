 ...
 *         &lt;element name="AuthenticationProfileToken" type="{http://www.onvif.org/ver10/pacs}ReferenceToken"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SetAccessPointAuthenticationProfile")
public class SetAccessPointAuthenticationProfile {

    @XmlElement(name = "Token", required = true)
    protected String token;
    @XmlElement(name = "AuthenticationProfileToken", required = true)
