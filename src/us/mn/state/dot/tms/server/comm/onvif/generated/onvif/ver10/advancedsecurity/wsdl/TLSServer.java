...
public interface TLSServer {
    ...
    @RequestWrapper(localName = "RemoveServerCertificateAssignment", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.RemoveServerCertificateAssignment")
    @ResponseWrapper(localName = "RemoveServerCertificateAssignmentResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.RemoveServerCertificateAssignmentResponse")
    void removeServerCertificateAssignment(
    ...
    @RequestWrapper(localName = "GetClientAuthenticationRequired", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.GetClientAuthenticationRequired")
    @ResponseWrapper(localName = "GetClientAuthenticationRequiredResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.GetClientAuthenticationRequiredResponse")
    ...
    @RequestWrapper(localName = "ReplaceServerCertificateAssignment", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.ReplaceServerCertificateAssignment")
    @ResponseWrapper(localName = "ReplaceServerCertificateAssignmentResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.ReplaceServerCertificateAssignmentResponse")
    void replaceServerCertificateAssignment(
    ...
    @RequestWrapper(localName = "AddCertPathValidationPolicyAssignment", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.AddCertPathValidationPolicyAssignment")
    @ResponseWrapper(localName = "AddCertPathValidationPolicyAssignmentResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.AddCertPathValidationPolicyAssignmentResponse")
    void addCertPathValidationPolicyAssignment(
    ...
    @RequestWrapper(localName = "RemoveCertPathValidationPolicyAssignment", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.RemoveCertPathValidationPolicyAssignment")
    @ResponseWrapper(localName = "RemoveCertPathValidationPolicyAssignmentResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.RemoveCertPathValidationPolicyAssignmentResponse")
    void removeCertPathValidationPolicyAssignment(
            @WebParam(name = "CertPathValidationPolicyID", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl")
                    String certPathValidationPolicyID
    );
    ...
    @RequestWrapper(localName = "ReplaceCertPathValidationPolicyAssignment", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.ReplaceCertPathValidationPolicyAssignment")
    @ResponseWrapper(localName = "ReplaceCertPathValidationPolicyAssignmentResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.ReplaceCertPathValidationPolicyAssignmentResponse")
    void replaceCertPathValidationPolicyAssignment(
    ...
    @RequestWrapper(localName = "AddServerCertificateAssignment", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.AddServerCertificateAssignment")
    @ResponseWrapper(localName = "AddServerCertificateAssignmentResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.AddServerCertificateAssignmentResponse")
    void addServerCertificateAssignment(
            @WebParam(name = "CertificationPathID", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl")
                    String certificationPathID
    );
    ...
    @RequestWrapper(localName = "GetAssignedServerCertificates", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.GetAssignedServerCertificates")
    @ResponseWrapper(localName = "GetAssignedServerCertificatesResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.GetAssignedServerCertificatesResponse")
    @WebResult(name = "CertificationPathID", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl")
    java.util.List<String> getAssignedServerCertificates();
    ...
    @RequestWrapper(localName = "GetAssignedCertPathValidationPolicies", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.GetAssignedCertPathValidationPolicies")
    @ResponseWrapper(localName = "GetAssignedCertPathValidationPoliciesResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.GetAssignedCertPathValidationPoliciesResponse")
    @WebResult(name = "CertPathValidationPolicyID", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl")
    java.util.List<String> getAssignedCertPathValidationPolicies();
     ...
     * The device shall execute this command regardless of the TLS enabled/disabled state configured in the ONVIF OnvifDevice Management Service.
     *       
     */
    ...
    @RequestWrapper(localName = "SetClientAuthenticationRequired", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.SetClientAuthenticationRequired")
    @ResponseWrapper(localName = "SetClientAuthenticationRequiredResponse", targetNamespace = "http://www.onvif.org/ver10/advancedsecurity/wsdl", className = "us.mn.state.dot.tms.server.comm.onvif.generated.onvif.ver10.advancedsecurity.wsdl.SetClientAuthenticationRequiredResponse")
    void setClientAuthenticationRequired(
